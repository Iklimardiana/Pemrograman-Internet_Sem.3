...
<body>
    ...
    Hasil panen : <input type="number" name="hasil_panen" value="<?php echo $data['hasil_panen']; ?>" /> <br />
    Lama tanam :<input type="number" name="lama_tanam" value="<?php echo $data['lama_tanam']; ?>" /> <br />
    Tanggal panen :<input type="date" name="tanggal_panen" value="<?php echo $data['tanggal_panen']; ?>" /> <br />
    <input type="submit" value="Update" />
    </form>
    <?php
    } else echo "Data tidak ditemukan";
    ?>
    <br /><a href='formdata.php'>Kembali</a>
</body>
</html>