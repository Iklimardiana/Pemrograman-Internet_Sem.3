...
$koneksi = mysqli_connect("localhost","root","","pertanian") or die("Koneksi Gagal");
    ...
    while($data = mysqli_fetch_array($query)){
        ?>
            <tr>
                ...
                <td>
                    <a href="Latihan1.php?aksi=update&id=<?php echo $data['id']; ?>&nama=<?php echo $data['nama_tanaman']; ?>&hasil=<?php echo $data['hasil_panen']; ?>&lama=<?php echo $data['lama_tanam']; ?>&tanggal=<?php echo $data['tanggal_panen']; ?>">Ubah</a> |
                    <a href="Latihan1.php?aksi=delete&id=<?php echo $data['id']; ?>">Hapus</a>
                </td>
            </tr>
        <?php
    }
...
function ubah($koneksi){
    ...
    if(isset($_GET['id'])){
        ?>
            <a href="Latihan1.php">
            <a href="Latihan1.php?aksi=create"> (+) Tambah Data</a>
            <hr>
            ...
            <fieldset>
                ...
                <br>
                <label>
                    <input type="submit" name="btn_ubah" value="Simpan Perubahan"/> atau <a href="Latihan1.php?aksi=delete&id=<?php echo $_GET['id'] ?>"> (x) Hapus data ini</a>!
                </label>
                <br>
                <p><?php echo isset($pesan) ? $pesan : "" ?></p>
